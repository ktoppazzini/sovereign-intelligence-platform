...
export async function POST(req) {
  ...
  // [KT:PERF-OPT-v1.0] Combined with PRE-TRANSLATE block below - single buildChartSummaryTranslations call
  ...
  if (canon.lang && !/^english$/i.test(canon.lang)) {
    ...
    translatedLabels = Object.assign({}, DEFAULT_LABELS, summaryTranslations);
  ...
  if (priorityResult.success && priorityResult.data) {
    ...
    if (prioritySpec.initiatives && prioritySpec.initiatives.length > 0) {
      ...
      const fallbackInitiatives = [
        { name: 'Digital Transformation', nameTranslated: null, impact: 95, effort: 90, value: 4.2 },
        { name: 'Process Automation', nameTranslated: null, impact: 85, effort: 30, value: 2.5 },
        { name: 'Quick Wins', nameTranslated: null, impact: 45, effort: 15, value: 0.8 },
        { name: 'Cloud Migration', nameTranslated: null, impact: 70, effort: 80, value: 1.8 },
        { name: 'Team Training', nameTranslated: null, impact: 50, effort: 20, value: 0.5 }
      ];
      const matrixTitle = translatedLabels?.prioritizationMatrix || 'Initiative Prioritization Matrix';
      prioritizationMatrix = prioritizationMatrixHTML({ 
        title: matrixTitle,
