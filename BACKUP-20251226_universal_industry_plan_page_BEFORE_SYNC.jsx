...
export default function UniversalIndustryPlanPage() {
  ...
  const baseLabels = useMemo(() => ({
    ...
    // [KT:PROGRESS-TRACKING] Track progress button
    trackProgress: 'Track Progress',
    trackProgressHint: 'Enable continuous tracking and AI-powered progress insights',
  }), []);
        ...
        {genDone && generatedHtml && (
          <>
            ...
            <div style={{
              ...
              {/* Left side: Track Progress Button */}
              <a
                href={`/universal-industry-plan/dashboard?lang=${lang}`}
                style={{
