...
async function onGenerate() {
  ...
  return (
    <div id="reformCard" className={styles.card}>
      ...
      <div className={styles.cardGrid} style={{maxWidth: 1400, margin: '0 auto', width: '100%'}}>
        {/* Left column */}
        <form onSubmit={onSubmit} aria-busy={submitting || loadingUI} className={styles.leftCol} style={{width: '100%', maxWidth: 700}}>
          ...
          {generatedHtml ? (
            <div className={styles.previewBox} style={{ marginTop: 12 }}>
              ...
              <iframe
                title="Reform Report"
                style={{
                  width: '100%', // [KT:SURGICAL:REPORT-WIDTH:CLAMPED] Clamped to 100% to prevent double report effect
                  // Legacy: width: '200%', // [KT:SURGICAL:REPORT-WIDTH] Doubled report window width for better readability
                  minWidth: 1200,
                  minHeight: 1200,
