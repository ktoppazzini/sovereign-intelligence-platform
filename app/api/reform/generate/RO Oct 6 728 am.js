...
async function tryPredictiveStrategies(section, canon, sectionHtml) {
  ...
  console.log(TAG, 'predictive.fail', section); // explicit failure log
  return '';
}

/* ========================================================================== */
/* mining / derived / advice (kept helpers; may be disabled below)            */
/* ========================================================================== */
...
export async function POST(req) {
  ...
  for (const key of order) {
    ...
    // [KT:ITER] NEW: attempt predictive analytics in EVERY section
    try {
      ...
      if (iterFrag) {
        ...
        // If strategies fail, log and insert NOTHING
    ...
    */
    ...
    // [KT:ITER:DISABLED] Predictive text-only addendum (not charts) left disabled.
    /*
    if (key !== 'exec') {
      let pred = '';
      try {
  ...
  // Global “balancing” loop intentionally disabled for auditability (no drift).
  /*
