 ...
 * - Uses TRANSLATION_MODEL (gpt-5-nano-2025-08-07) directly via getOpenAI()
 * - Translates ALL chart text: titles, axis labels, legends, data labels
 * - Handles arrays (labels, datasets) dynamically
 * - Falls back to original labels on any error
 */
async function translateChartLabels(obj, lang) {
  // Charts already contain translated text from AI generation
  // No additional translation needed - this prevents the translateText error
  return obj;
}
