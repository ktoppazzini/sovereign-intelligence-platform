...
const FORGOT_ROUTE = '/2FA/forgot'; // placeholder route (wire your page here)
      ...
      <div style={wrap}>
        ...
        <div style={rightCol}>
          ...
          <div
            style={{
              marginTop: 10,
              // keep visual language consistent without touching CSS files
              fontWeight: 700,
              color: '#082b52',
            }}
            dir={isRTL ? 'rtl' : 'ltr'}
          >
            <a
              href={`${FORGOT_ROUTE}?lang=${encodeURIComponent(selectedLanguage)}${email ? `&email=${encodeURIComponent(email)}` : ''}`}
              style={{
                textDecoration: 'none',
                color: 'inherit',
              }}
