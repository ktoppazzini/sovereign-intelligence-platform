...
`;
  ...
  const tocItems = [
    ...
    'Implementation Plan','Operating Model','Risks & Mitigations','ROI & Next Steps','Next Steps'
  ].map((t)=>`<li>${t}</li>`).join('');
...
`;
  ...
  reportHtml += `
    ...
    <!-- [KT:SURGICAL:NEXT-STEPS-SECTION] Standalone Next Steps section inserted before appendices -->
    <section id="next-steps" class="report-section">
      <h2>Next Steps</h2>
      <!-- TODO: Inject AI-generated Next Steps content here -->
      ${SEC.nextSteps ? SEC.nextSteps.html : '<p>[Next Steps content will be generated here]</p>'}
    </section>
  </article>
`;
