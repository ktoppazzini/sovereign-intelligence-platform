...
.chart-card{ background:#000000; color:#000000; border-radius:16px; padding:12px; box-shadow:0 2px 10px rgba(0,0,0,.06); }
...
.chart-type select{ background:#FFA500; color:#FFFFFF; border:1px solid #000000; border-radius:8px; padding:4px 8px; }
...
.chart-heat .hm-legend i{ flex:1; height:10px; border-radius:6px;
  background: linear-gradient(90deg, hsla(198, 13%, 20%, 1.00), hsl(160,80%,55%)); }
