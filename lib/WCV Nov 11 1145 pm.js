...
export function riskHeatmapHTML(risks = []) {
  ...
  function chartSummaryRowRisk({ risks }) {
    ...
    // Remove [AI] from label and use correct summary
    return `
      <div class="chart-summary" style="font-size:16px; color:#FFFFFF; margin-bottom:8px; display:flex; align-items:flex-start; gap:8px;">
        <input type="checkbox" checked disabled style="accent-color:#10B981; margin-top:3px;" aria-label="Summary" />
        <div style="flex:1;">
