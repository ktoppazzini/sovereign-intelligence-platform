...
export function executiveSummaryInfographicHTML(summary = {}) {
  ...
  console.log('🎯 [EXEC-INFOGRAPHIC-v3.1] Generating with lang:', lang, 'and translations:', {
  ...
  return `
    <div class="executive-infographic" style="background: linear-gradient(135deg, #0B1A3D 0%, #1e3a5f 100%); padding: 2rem 1.5rem; border-radius: 16px; margin: 2rem 0; max-width: 100%; box-sizing: border-box;">
      <h2 style="text-align: center; color: #10B981; font-size: 2rem; margin-bottom: 2rem; font-weight: 700;">${getLabel("Executive Summary at a Glance")}</h2>
      ...
      <div style="background: rgba(0,0,0,0.3); border-radius: 8px; padding: 1.5rem 1rem; margin-bottom: 1.5rem;">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; max-width: 100%;">
          <div style="flex: 1; text-align: center; min-width: 0;">
            ...
            <div style="color: #FFFFFF; font-size: 0.75rem; font-weight: 600;">${getLabel("Discovery")}</div>
            <div style="color: rgba(255,255,255,0.6); font-size: 0.95rem; margin-top: 0.5rem;">4 ${getLabel("weeks")}</div>
          </div>
          ...
          <div style="flex: 1; text-align: center; min-width: 0;">
            ...
            <div style="color: #FFFFFF; font-size: 0.75rem; font-weight: 600;">${getLabel("Design")}</div>
            <div style="color: rgba(255,255,255,0.6); font-size: 0.95rem; margin-top: 0.25rem;">4 ${getLabel("weeks")}</div>
          </div>
          <div style="flex: 0 0 30px; text-align: center;">
            <svg width="30" height="16" viewBox="0 0 30 16">
              <path d="M 0 8 L 25 8 M 20 4 L 25 8 L 20 12" stroke="#10B981" stroke-width="2" fill="none"/>
          ...
          <div style="flex: 1; text-align: center; min-width: 0;">
            ...
            <div style="color: #FFFFFF; font-size: 0.75rem; font-weight: 600;">${getLabel("Pilot")}</div>
            <div style="color: rgba(255,255,255,0.6); font-size: 0.95rem; margin-top: 0.25rem;">4 ${getLabel("weeks")}</div>
          </div>
          <div style="flex: 0 0 30px; text-align: center;">
            <svg width="30" height="16" viewBox="0 0 30 16">
          ...
          <div style="flex: 1; text-align: center; min-width: 0;">
            ...
            <div style="color: #FFFFFF; font-size: 0.75rem; font-weight: 600;">${getLabel("Scale")}</div>
            <div style="color: rgba(255,255,255,0.6); font-size: 0.95rem; margin-top: 0.25rem;">12 ${getLabel("weeks")}</div>
          </div>
        </div>
      </div>
