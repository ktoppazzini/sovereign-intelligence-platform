...
function benefitsHTML(model, L = {}) {
  ...
  <section class="appendix">
    ...
    <table class="table small">
      <thead>
        <tr>
          <th data-i18n-key="appendixD.workstream">${L.workstream || "Workstream"}</th>
          <th data-i18n-key="appendixD.lever">${L.lever || "Lever"}</th>
          <th data-i18n-key="appendixD.unitAssumption">${L.unitAssumption || "Unit Assumption"}</th>
          <th data-i18n-key="appendixD.source">${L.source || "Source"}</th>
          <th data-i18n-key="appendixD.volume">${L.volume || "Volume"}</th>
          <th data-i18n-key="appendixD.rate">${L.rate || "Rate"}</th>
          <th data-i18n-key="appendixD.monthly">${L.monthlySavings || "Monthly $"}</th>
          <th data-i18n-key="appendixD.confidence">${L.confidence || "Confidence"}</th>
          <th data-i18n-key="appendixD.start">${L.startMonth || "Start"}</th>
          <th data-i18n-key="appendixD.runRate">${L.runRate || "Run-rate"}</th>
          <th data-i18n-key="appendixD.oneOff">${L.oneOffCost || "One-off $"}</th>
        </tr>
      </thead>
      <tbody>${rows}</tbody>
    </table>
    ...
    <table class="table small">
      <thead>
        <tr>
          ...
          <th data-i18n-key="appendixH.notes">${L.normalizationNotes || "Normalization notes"}</th>
        </tr>
      </thead>
      <tbody>
        ${benchmarks
...
function decisionFrameworkHTML(model = {}, L = {}) {
  ...
  <section class="appendix">
    ...
    <table class="table small">
      <thead>
        <tr>
          <th data-i18n-key="appendixJ.decision">${L.decision || "Scenario"}</th>
          <th data-i18n-key="appendixJ.criteria">${L.criteria || "Symptoms"}</th>
          <th data-i18n-key="appendixJ.options">${L.options || "Root Cause"}</th>
          <th data-i18n-key="appendixJ.recommendation">${L.recommendation || "Recommended Action"}</th>
          <th data-i18n-key="appendixJ.rationale">${L.rationale || "Rationale"}</th>
          <th data-i18n-key="appendixJ.owner">${L.owner || "Owner"}</th>
          <th data-i18n-key="appendixJ.status">${L.status || "Status"}</th>
        </tr>
      </thead>
      <tbody>
        ${rows}
...
function resourceRequirementsHTML(model = {}, L = {}) {
  ...
  <section class="appendix">
    ...
    <table class="table small">
      <thead>
        <tr>
          <th data-i18n-key="appendixK.resource">${L.resource || "Resource"}</th>
          <th data-i18n-key="appendixK.role">${L.role || "Role"}</th>
          <th data-i18n-key="appendixK.quantity">${L.quantity || "Quantity"}</th>
          <th data-i18n-key="appendixK.duration">${L.duration || "Duration"}</th>
          <th data-i18n-key="appendixK.cost">${L.cost || "Cost"}</th>
          <th data-i18n-key="appendixK.notes">${L.notes || "Notes"}</th>
        </tr>
      </thead>
      <tbody>
        ${rows}
...
function buildAllAppendices({
  ...
  const content = [
    ...
    methodsSourcesHTML(methodsSources, L),
    // [KT:SURGICAL] Enforce appendix order: I before J (swap was causing J to appear first)
    decisionFrameworkHTML(decisionFramework, L),
    implementationChecklistHTML(implementationChecklist, L),
    resourceRequirementsHTML(resourceRequirements, L),
  ]
    .filter(Boolean)
    .join("\n");
