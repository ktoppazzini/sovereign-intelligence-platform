...
// ═══════════════════════════════════════════════════════════════════════════
// SOVEREIGN AI - Centralized Self-Learning AI Service
// ═══════════════════════════════════════════════════════════════════════════
// 
// This module wraps ALL AI calls with Sovereign's self-learning capabilities:
...
function enhancePrompt(basePrompt, context = {}) {
  ...
  const identityContext = `You are Sovereign, the AI intelligence powering the Sovereign Intelligence platform.
 ...
 * @param {string} options.prompt - The base prompt
...
export async function sovereignAICall(options) {
  ...
  console.log(TAG, 'call.start', { callType, vertical, lang });
  
  try {
    const openai = await getOpenAI();
    
    // Enhance prompt with Sovereign intelligence
    const enhancedPrompt = skipEnhancement 
      ? prompt 
      : enhancePrompt(prompt, { callType, vertical, lang });
    ...
    // Validate and learn from response
