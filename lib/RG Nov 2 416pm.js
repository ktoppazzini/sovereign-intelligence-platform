...
/* ===========================================================
   ...
   ===========================================================*/
/* [KT:SURGICAL:GLOBAL-TYPE-SWITCHER]
   - Delegated `change` listener for all `.chart-type select`
   - Initializes on DOMContentLoaded
   - Observes DOM mutations and auto-initializes new `.chart-card`s
*/
(function(){
  ...
  document.addEventListener('change', function(e){
    var target = e.target && e.target.closest && e.target.closest('.chart-type select');
    if (!target) return;
