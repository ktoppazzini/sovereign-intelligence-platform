...
// [KT:SURGICAL:I18N-TITLE-PAGE]
// Wrap all static title page text in L[...] map.
// No deletions — original values preserved for fallback.

const TL = {
  titlePlan: L.titlePlan || 'Strategic Transformation & Value Creation Plan',
  atAGlance: L.atAGlance || 'At a Glance',
  tableOfContents: L.tableOfContents || 'Table of Contents',
  executiveSummary: L.executiveSummary || 'Executive Summary'
};
...
<article class="report" dir="${direction}" lang="${esc(canon?.lang || 'en')}">
    ...
    <section class="title-page">
      ...
      <div class="title-main">
        ...
        <h2 class="title-subtitle">${esc(TL.titlePlan)}</h2>  // [KT:SURGICAL:I18N]
...
`;
  ...
  if (worldClassVisuals.execInfographic) {
    ...
    <section class="executive-infographic-section">
     ...
     // [KT:SURGICAL:I18N-AT-A-GLANCE]
<h2 class="ataglance-title">${esc(L.atAGlance || 'At a Glance')}</h2>
...
// [KT:SURGICAL:I18N-EXEC-SUMMARY]
<h2 class="section-title">${esc(L.executiveSummary)}</h2>
