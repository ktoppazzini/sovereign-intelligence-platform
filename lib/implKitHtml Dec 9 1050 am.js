...
function decisionFrameworkHTML(model = {}, L = {}) {
  ...
  <section class="appendix">
    ...
    <table class="table small">
      <thead>
        <tr>
          <th data-i18n-key="appendixJ.decision">${L.decision || "Decision"}</th>
          <th data-i18n-key="appendixJ.criteria">${L.criteria || "Criteria"}</th>
          <th data-i18n-key="appendixJ.options">${L.options || "Options"}</th>
          <th data-i18n-key="appendixJ.recommendation">${L.recommendation || "Recommendation"}</th>
