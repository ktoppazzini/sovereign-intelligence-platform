...
/* Removed duplicate import of planDiagramHTML to avoid conflict */
// app/reform-report/ReportTemplate.js
// [KT:SURGICAL] Report template injects GRAPH_CSS once and provides slots for figures.

/* ============================================================================
// MULTILINGUAL LABELS - 207 Languages Support
// Default English labels that will be translated via GPT-5-nano
// ============================================================================*/
...
`;
  ...
  <style>
    ...
    .report{ 
      ...
      margin:0 auto; 
      padding: 0.75in 0.75in 0.75in 0.75in; /* Visible 0.75in margins all around */
      overflow-x:hidden;
      color-scheme:dark; 
      background:#0a0e1a; /* Deep navy instead of pure black */
      color:#e8eefb; 
