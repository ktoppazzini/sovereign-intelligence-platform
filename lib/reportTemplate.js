...
export default function buildReformReportHTML(opts) {
    ...
    const { canon, sections = {}, phases = [], implKit, translatedLabels, labels: labelsPassed, worldClassVisuals = {}, appendicesHTML: optsAppendicesHTML } = (opts || {});
...
<figure data-widget="series" data-chart-id="exec-savings">
  ...
  >
    ...
    <!-- [KT:PREDICTIVE-INTELLIGENCE] AI-Powered Predictive Analytics -->
