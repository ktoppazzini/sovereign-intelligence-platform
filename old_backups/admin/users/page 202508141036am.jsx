...
export default function UsersAdminPage() {
  ...
  const [orgId, setOrgId] = useState(''); // not used by the /accounts API, but we preserve the input
  const [roleIds, setRoleIds] = useState(''); // not used as IDs; we map to a single "Role" field
  ...
  // Note: we keep your existing DOM structure/classes for the header/inputs/btns section.
  return (
    <div style={wrapStyle}>
      ...
      <main style={mainStyle}>
        {/* Top input row (kept as-is; bind to state) */}
        <div
          className="inputRow"
