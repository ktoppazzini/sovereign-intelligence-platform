...
// ---- minimal inline styles (keep your layout as-is) ----
...
export default function UsersAdminPage() {
  ...
  const i18nMode = qs.get('i18n') === '1'; // keep parity with Admin page reference

  // Translation (same method/pattern as Admin reference)
  const [t, setT] = useState({
    ...
    role: 'Role',
    actions: 'Actions',
    couldntLoad: 'Could not load users. Check Airtable credentials / table name.',
...
`.trim();
  ...
  // shared form state (used by all blocks)
  ...
  // ---- table (kept identical layout, with status/errors and actions) ----
  function UsersTable() {
    return (
      <div
        style={{
  ...
  // ---- UI (kept same structure; top “Add” row is back) ----
  return (
    <div style={wrapStyle}>
      {/* LEFT */}
      ...
      <main style={mainStyle}>
        ...
        {showDebug && (
          ...
          >
            {JSON.stringify({ lang, i18nMode, debug }, null, 2)}
          </pre>
        )}
      </main>
    </div>
