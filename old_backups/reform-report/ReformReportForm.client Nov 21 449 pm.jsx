...
import useTranslation from '../hooks/useTranslation'; // [KT:SURGICAL:I18N-HOOK]
...
const { t, rtl, loading } = useTranslation(BASE_UI, langParam);
  ...
  // Finalize handler (stub implementation to prevent errors)
  async function onFinalize() {
    setFinalizing(true);
    setFinalizeDone(false);
    try {
      // TODO: Implement finalize logic (e.g., API call)
