...
async function translateChartLabels(obj, lang) {
  ...
  try {
    ...
    console.warn(TAG, 'chart.labels.translate.error', String(e?.message || e));
    return obj;
  }
}
...
if (canon.lang && canon.lang !== 'English') {
  try {
    ...
    console.warn(TAG, 'kpi.savings.translate.error', String(e?.message || e));
  }
}
...
if (canon.lang && canon.lang !== 'English') {
  try {
    ...
    console.warn(TAG, 'kpi.payback.translate.error', String(e?.message || e));
  }
}
...
kpiCharts += paybackChart + '\n';
  ...
  if (canon.lang && canon.lang !== 'English') {
    try {
      ...
      console.warn(TAG, 'kpi.benchmark.translate.error', String(e?.message || e));
    }
  }
...
`.trim();
    ...
    try {
      ...
      console.warn('[genResourceRequirements] First 400 chars of bad payload:', raw.slice(0, 400));
      return {
        team: [
          {
        ...
        training: [
          {
            ...
            hoursPerPerson: 6,
            owner: 'HR / L&D',
            successCriteria: 'Managers can explain new KPIs and coach their teams.',
          },
        ],
      };
    }
  } catch (err) {
    console.error('[genResourceRequirements] OpenAI call failed; returning default skeleton', err);
    return {
      team: [],
      budget: [],
      tools: [],
