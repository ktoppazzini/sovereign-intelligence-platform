...
/* ========================================================================== */
/*
  Purpose: Ensure EVERY visual (<figure data-chart>, <figure data-widget="benchmark">, <div data-heatmap>)
  has a concise executive description (2–3 sentences) immediately BELOW it.
  ...
  Behavior:
    ...
    - Inserts without altering the visual markup or generation logic.

  Constraints:
    - No deletion of existing code; purely additive.
    - Applies post-template-assembly, after table title injection.
*/
...
export async function POST(req) {
  ...
  try {
    html = injectTableTitles(html); // <-- EXACT LINE WHERE TITLE INJECTION IS INVOKED
  ...
  // Ensure EVERY visual has an executive note below it (charts, benchmarks/dashboards, heatmaps).
  try {
