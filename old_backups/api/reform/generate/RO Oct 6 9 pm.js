...
function renderVizFromJSON(section, json) {
  ...
  // Coerce benchmark-like ideas to a simple bar chart (two categories)
...
// legacy path commented out (surgical, no deletion)
*/

/* ========================================================================== */
/* mining/derived/advice helpers (kept for audit; unused in main path)         */
/* ========================================================================== */
// ... (unchanged helpers retained but not used in predictive path)
...
export async function POST(req) {
  ...
  // Keep existing defaults (unchanged; surgical)
  const canon = {
