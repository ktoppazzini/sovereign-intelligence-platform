...
// === MULTILINGUAL SUPPORT - LABEL + FULL HTML TRANSLATION ===
// (Duplicate TRANSLATION_MODEL declaration removed to fix parse error)
...
console.log('[LANG] translatedLabels loaded:', {
  lang: canon.lang,
  sample: translatedLabels?.projectOverview
});
...
if (key === 'nextSteps') {
  ...
  // === MULTILINGUAL: Translate UI labels via GPT-5-nano ===
  // translatedLabels is already defined above
...
//}
  ...
  // === MULTILINGUAL: Full HTML translation pass (final) ===
if (canon.lang && !/^english$/i.test(canon.lang)) {
  console.log('[LANG] Running full HTML translation for:', canon.lang);
  html = await translateHTML(html, canon.lang);
  console.log('[LANG] Full HTML translation complete:', {
    lang: canon.lang,
    length: html.length
  });
} else {
  console.log('[LANG] Skipping final translation (English/no-lang)');
}
...
export async function __kt_buildAppendices_FromImplementationKit(reportHTML, canon, sections){
    ...
    */
    ...
    try {
      ...
      // [KT:SURGICAL:OPENAI-MAX-TOKENS-FIX]
      // Accept both OpenAI v1 (max_tokens) and v2 (max_completion_tokens) models.
      // This block is for logging and future-proofing; no effect here, but mirrors translation fix.
      if (resourceRequirements && (
        ...
        console.log('[APPENDIX-K] ✔️ Data found:', {
          ...
          // [KT:SURGICAL:OPENAI-MAX-TOKENS-FIX] log OpenAI model version for audit
          openaiModel: MODEL,
        });
      } else {
        let reasons = [];
        ...
        console.warn('[APPENDIX-K] ❌ No real data for:', reasons.join(', '), { openaiModel: MODEL });
      }
    } catch (e) {
