...
try {
  ...
  */
  ...
  /* [KT:SURGICAL:APPENDIX-ORDER-FIX] Commented out logic that places appendices after the conclusion. Appendices I, J, K will be rendered after section H and before the conclusion by the finalized report logic. */
  // {
  //   const re = /(<section id=["']appendices["'][\s\S]*?<\/section>)/i;
  //   if (re.test(html)) {
