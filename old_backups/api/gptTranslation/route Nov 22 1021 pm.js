...
export async function POST(req) {
  ...
  try {
    ...
    // Ensure all buttons are translated: If body.buttons is provided (array of button labels), translate them as well
    ...
    // If you want to translate additional fields, add them here
    // For example: dropdownOptions, countries, etc.
    // This ensures all provided fields are translated, not just UI labels or text.

    // If body.countries is provided (array of country names), translate them as well
    ...
    // === TRANSLATE ALL DROP DOWN OPTIONS ====================================
    // If body.dropdownOptions is provided (array of strings), translate them as well
